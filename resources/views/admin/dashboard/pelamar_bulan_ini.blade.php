...
@section('title', 'Pelamar Bulan Ini')

@section('content')
<div class="container">
    <!-- Header -->
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="fw-bold text-primary">PELAMAR BULAN INI</h4>
        <div class="input-group" style="width: 300px;">
            <input type="text" class="form-control" placeholder="Cari Pelamar">
            <span class="input-group-text">Total : {{ $pelamar->count() }}</span>
        </div>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <strong>Daftar Pelamar Bulan {{ \Carbon\Carbon::now()->translatedFormat('F Y') }}</strong>
        </div>
        <div class="card-body p-0">
            <table class="table table-striped table-bordered mb-0">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center">Belum ada pelamar bulan ini</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
